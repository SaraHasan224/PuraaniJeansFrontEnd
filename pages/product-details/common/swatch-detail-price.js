    ...
    <>
      <div className={`product-right ${params.stickyClass}`}>
        ...
        <ul className="image-swatch">
          <li className="active">
            <a href="#">
              <img src={img1.src} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={img2.src} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
          <li>
            <a href="#">
              <img src={img3.src} alt="" className="img-fluid blur-up lazyloaded" />
            </a>
          </li>
        </ul>
